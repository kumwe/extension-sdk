...
This is the common Kumwe package release contract. Apply it to each package.
...
`release-verified` and downstream adoption decisions under the release qualification contract.
