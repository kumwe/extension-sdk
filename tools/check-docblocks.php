 ...
 * matching how the library is written (one member per declaration line,
 * PSR-12 shapes). A shape it cannot classify fails closed. An empty or absent
 * `src/` is a passing state — zero members means zero violations — so the
 * lane is green from the founding commit onward.
 *
 * @since 0.1.0
 */
